...
Function Write-BaseMetrics
{
    ...
    while ($1 -ne 5)
    {
        ...
        $topProcessor = $counters | ?{$_.Path -like "*% processor time*" -and $_.Path -notlike "*processor(*" -and $_.InstanceName -ne "idle" -and $_.InstanceName -notlike "*_total*" -and $_.Path -notlike "*#*" -and $_.CookedValue -gt 0} | sort CookedValue -desc | select -First 10
